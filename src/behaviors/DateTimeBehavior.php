...
class DateTimeBehavior extends Behavior
{
    ...
    public function __get($name)
    {
        if (($realName = $this->isBehaviorProperty($name)) !== false) {
            ...
            switch ($type) {
                ...
                case self::TYPE_DATE:
                    /** @var Carbon $result */
                    $result = $this->dateTimeClass::createFromFormat($this->typeFormats[$type], $this->owner->{$realName});
                    $result->setTime(0, 0, 0);
                    break;
                case self::TYPE_TIME:
                    /** @var Carbon $result */
                    $result = $this->dateTimeClass::createFromFormat($this->typeFormats[$type], $this->owner->{$realName});
                    $result->setDate(0, 0, 0);
                    break;
                default:
    ...
    public function __set($name, $value)
    {
        ...
        $this->owner->__set($name, $value); // TODO: Change the autogenerated stub
    }
